...
class DataIngestion:
    ...
    def split_data(self):
        try:
            ...
            train_data,test_data = train_test_split(data,test_size= 1-self.train_test_ratio,random_state=5)
            ...
            raise CustomException("Failed to split data into training and test Splits",e) 
    ...
    def run(self):
        ...
        try:
            ...
            logger.info("Data ingestion complted Successfully")
