...
class DataProcessor:
    ...
    def load_data(self,use_cols):
        try:
            ...
            logger.error("Error while loading data for data procesing")
            raise CustomException("failed to load data for data procesing", e)
    ...
    def filter_users(self,min_rating=400):
        try:
            ...
            raise CustomException('failed while filtering data in data Processing')
    ...
    def scale_ratings(self):
        try:
            ...
            raise CustomException('failed while Scaling data in data Processing')
    ...
    def encode_data(self):
        try:
            ...
            logger.info('encoding data for user and anime Done Successfully...')

        except Exception as e:
            raise CustomException('failed while encoding data in data Processing')

    def split_data(self,test_size = 1000,random_state = 4):
        try:

            self.rating_df = self.rating_df.sample(frac=1,random_state=5).reset_index(drop=True)
            ...
            raise CustomException('failed while data Splitting in data Processing',e)
    ...
    def save_artifacts(self):
        try:
            ...
            logger.info("All the training and testing data is saved now")

        except Exception as e:
            raise CustomException('failed while saving train and test data in data Processing',e)
    ...
    def process_anime_data(self):
        try:
            ...
            raise CustomException('failed while saving DF and Synopsis_df data in data Processing',e)
    

    def run(self):
        try:
            self.load_data(use_cols = [
            ...
            logger.info('Data processing Pipeline Successfully')

        except Exception as e:
            logger.error("Error in the Data Processing Pipleline for data procesing")
            raise CustomException('failed in the Data Processing Pipleline in data Processing',e)
