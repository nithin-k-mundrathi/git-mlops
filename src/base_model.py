...
class BaseModel:
    def __init__(self,config_path):
        try:
            ...
            raise CustomException('Error While loading Configuration',e)
    ...
    def RecommenderNet(self,n_users,n_anime):
        try:
            ...
            logger.error(f'Error Occured in model architechture')
            raise CustomException('Error Failed to create Model in model architechture',e)
